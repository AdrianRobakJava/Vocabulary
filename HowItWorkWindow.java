		...
		if(language.equals("EN")) {
			...
			informationTA.setText(
					"1. Program został napisany aby pomóc w nauce słówek w obcym języku."
							...
							+ "\n4. Następnie wciśnij przycisk (Następny Wyraz) aby wylosować wyraz do tłumaczenia."
							+ "\n5. Wprowadź poprawną odpowiedź i wciśnij przycisk \"Sprawdź\""
							+ "\n6. Po dziesięciu poprawnych odpowiedziach z rzędu, dane słówko zostaje uznane za nauczone i przeniesione do listy wyrazów nauczoonych."
							+ "\n7. Jeśli odpowiedź nie jest poprawna, to liczba poprawnych odpowiedzi danego słówka zostaje zmniejszona o trzy."
							+ "\n8. Przed zamknięciem programu należy zapisać stan aby nie utracić wprowadzonych danych."
							+ "\n9. Po uruchomieniu programu należy wczytać dane."
					);
