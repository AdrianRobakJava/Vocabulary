...
public class LearnWindow {
	...
	public void nextWord() {
		...
		if (wordsList.getWordsList().size() > 0) {
			...
			if (language.equals("EN")) {
				...
				correctL.setText("Nauczy³eœ siê ju¿ wszystkich wprowadzonych wyrazów.");
			}
		}
	}
		...
		if (wordsList.getWordsList().size() > 0) {
			if (temp.equals(word.getYourWord())) {
				...
				if (language.equals("EN")) {
					...
					correctL.setText("Dobrze, poprawna odpowiedŸ!\n " + word.getYourWord() + " ");
				}
				checkButton = 0;
			...
			if (language.equals("EN")) {
				...
				correctL.setText("Nauczy³eœ siê ju¿ wszystkich s³ówek!");
			}
		}
	}
	...
	public void changeMenuLanguage() {
		if (language.equals("EN")) {
			...
			checkB.setText("SprawdŸ");
			nextWordB.setText("Nastêpne S³owo");
			showTranslationB.setText("Poka¿ T³umaczenie");
			...
			try {
				if (wordsList.getWordsList().size() == 0 && wordsList.getLearnedWordsList().size() == 0) {
					...
					if (language.equals("EN")) {
						...
						saveL.setText("Dane by³y ju¿ wczytane.");
					}
				}
			} catch (Exception e) {
				e.printStackTrace();
